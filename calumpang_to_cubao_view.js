...
const options = {
    center: { lat: 14.63043, lng: 121.09065 },
    zoom: 12,
...
function initMap1() {
    ...
    const route = {
        origin: { lat: 14.63227, lng: 121.08012 },
        destination: { lat: 14.622, lng: 121.09311 },
        travelMode: 'DRIVING',
        waypoints: [
...
function initMap2() {
    ...
    const route = {
        origin: { lat: 14.622, lng: 121.09311 },
        destination: { lat: 14.63227, lng: 121.08012 },
        travelMode: 'DRIVING',
        waypoints: [
          { location: { lat: 14.62264, lng: 121.09664 } }, 
          { location: { lat: 14.6239, lng: 121.0961 } },
          { location: { lat: 14.63267, lng: 121.09665 } },
          { location: { lat: 14.63285, lng: 121.0977 } },
          { location: { lat: 14.63536, lng: 121.09739 } },
